                            ...
                            <tbody>
                                ...
                                if ($page=="All") {
                                    foreach($result_categories as $row) {
                                        ?>
                                <tr>
                                    <td class="pt-4" scope="row"><?php echo $row['category_id'] ?></td>
                                    ...
                                    <td>
                                        <div class="operations ">
                                            <a href="category.php?page=onePage&catId=<?= $row['category_id'] ?>" class="btn btn-link font-weight-bold"><i
                                                    class="fa-regular fa-eye"></i> show</a>
                                            <a href="category.php?page=delete&catId=<?= $row['category_id'] ?>" class="btn btn-link text-danger font-weight-bold"><i
                                ...
                                <!-- one page -->
                                <?php
                                if ($page=="onePage" && isset($_GET['catId'])) {
                                    foreach($result_categories as $row) {
                                ?>
                                <tr>
                                    <td class="pt-4 text-center" scope="row"><?php echo $row['category_id'] ?></td>
                                    ...
                                    <td>
                                        <div class="operations ">
                                            <a href="category.php?page=All&catId=<?= $row['category_id'] ?>" class="btn btn-link font-weight-bold"><i
